...
function(t, e, o) {
    var i = {
        init: function(e, o) {
            var i = this;
            i.$elem = t(o), i.options = t.extend({}, t.fn.owlCarouselTwo.options, i.$elem.data(), e), i.userOptions = e, i.loadContent()
        },
    ...
    t.fn.owlCarouselTwo = function(e) {
